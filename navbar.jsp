...
<div>
    <h3>
        <img src="img/logo (2).jpeg" alt="Book Icon" style="width:80px; height:50px; vertical-align:middle;">
        BOOKIFY
    </h3>
</div>
</div>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link" href="all_recent_book.jsp">All Recent Books</a></li>
		<li class="nav-item active"><a class="nav-link" href="all_new_book.jsp">All new Books</a></li>
<li class="nav-item active"><a class="nav-link disabled" href="all_old_book.jsp"><i class="fas fa-book-open"></i> OldBook</a></li>
		</ul>
